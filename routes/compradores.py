...
@compradores.post("/compradores", response_model=CompradorModel)
...
@compradores.delete("/compradores/{id}", status_code=status.HTTP_204_NO_CONTENT)
...
@compradores.put("/compradores/{id}")
